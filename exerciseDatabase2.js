...
const exerciseLibrary = [
  ...
  },
  {
    ...
    isActiveRecovery: false,
    alternatives: ["dumbbell_row", "seated_row_band", "lat_pulldown"],
  ...
  },
  {
    ...
    equipment: "polea",
    isActiveRecovery: false,
    alternatives: ["tube_band_tricep_extension", "push_up", "overhead_press"],
  ...
  },
  {
    ...
    equipment: "polea",
    isActiveRecovery: false,
    alternatives: ["seated_row_band", "dumbbell_row", "tube_band_row_one_arm"],
  ...
  },
  {
    ...
    isActiveRecovery: false,
    alternatives: ["glute_bridge", "hip_abduction", "single_leg_rdl"],
  ...
  },
  {
    ...
    equipment: "máquina",
    isActiveRecovery: false,
    alternatives: ["hip_abduction", "glute_bridge", "tube_band_hip_thrust"],
  ...
  },
  {
    ...
    equipment: "barra dominadas",
    isActiveRecovery: false,
    alternatives: ["bicep_curl", "dumbbell_row", "tube_band_bicep_curl"],
  ...
  },
  {
    ...
    isActiveRecovery: false,
    alternatives: ["tube_band_row_one_arm", "seated_row_band", "pull_up"],
  ...
  },
  {
    ...
    isActiveRecovery: false,
    alternatives: ["tube_band_face_pull", "band_pull_apart", "reverse_fly"],
  ...
  },
  {
    ...
    equipment: "máquina",
    isActiveRecovery: false,
    alternatives: ["goblet_squat", "wall_sit", "lunges"],
  ...
  },
  {
    ...
    isActiveRecovery: false,
    alternatives: ["push_up", "tube_band_chest_press", "incline_press"],
  ...
  },
  {
    ...
    equipment: "máquina",
    isActiveRecovery: false,
    alternatives: ["wall_sit", "tube_band_squat", "goblet_squat"],
  ...
  },
  {
    ...
    equipment: "máquina",
    isActiveRecovery: false,
    alternatives: ["nordic_curl", "romanian_deadlift", "tube_band_romanian_deadlift"],
  ...
  },
  {
    ...
    isActiveRecovery: false,
    alternatives: ["jump_squat", "lunges", "step_up"],
  ...
  },
  {
    ...
    phases: { eccentric: 3, isometric: 2, concentric: 2, rest: 45 },
    genderPhases: {
      female: { eccentric: 3, isometric: 2, concentric: 2, rest: 30 },
      male:   { eccentric: 3, isometric: 2, concentric: 2, rest: 45 },
    },
    seriesDefault: 3,
    repsDefault: 8,
    unilateral: true,
  ...
  },
  {
    ...
    equipment: "polea",
    isActiveRecovery: true,
    alternatives: ["tube_band_pallof_press_band", "dead_bug", "side_plank"],
...
const unisexRoutines = [
  ...
  // GIMNASIO
  { id: "gym_powerlifting_base", name: "🏋️ Powerlifting Base", gender: "unisex", daysPerWeek: 4, difficulty: "avanzado", category: "fuerza", description: "Los tres levantamientos principales con periodización lineal. Series de 5 reps: zona óptima de fuerza máxima. Pausa isométrica de 1s en el punto de mayor carga activa mayor número de unidades motoras. Schoenfeld (2024): 3-5 series de 3-6 reps al 80-90% RM maximizan la ganancia de fuerza máxima.", exercises: ["squat","deadlift","bench_press","overhead_press","pull_up","bent_over_row"], seriesPerEx: 5, repsPerEx: 5 },
  { id: "gym_upper_lower_volume", name: "📐 Upper/Lower Volumen 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "intermedio", category: "hipertrofia", description: "División superior/inferior con alto volumen. Schoenfeld (2012): periodización ondulante diaria es superior a la lineal para hipertrofia a largo plazo. Día 1-2 fuerza (4×6), día 3-4 hipertrofia (3×12).", exercises: ["squat","leg_press","romanian_deadlift","leg_curl","leg_extension","hip_abduction","glute_bridge","bench_press","bent_over_row","overhead_press","seated_cable_row","bicep_curl","triceps_pushdown","face_pull"], seriesPerEx: 4, repsPerEx: 8 },
  { id: "gym_athletic_performance", name: "⚡ Rendimiento Atlético 5 días", gender: "unisex", daysPerWeek: 5, difficulty: "avanzado", category: "funcional", description: "Potencia, fuerza y prevención de lesiones para deportistas. Lum et al. (2021): IST + pliometría mejora CMJ 4-8%. Protocolo Oslo de nórdico: 65% reducción de roturas isquiotibiales. Farmer walk y suitcase carry para core funcional en movimiento.", exercises: ["squat","deadlift","box_jump","pull_up","incline_press","nordic_curl","single_leg_rdl","bulgarian_split_squat","farmer_walk","suitcase_carry","pallof_press","copenhagen_plank"], seriesPerEx: 4, repsPerEx: 6 },

  // CASA
  { id: "home_intermediate_bodyweight", name: "🏠 Calistenia Intermedio 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "intermedio", category: "calistenia", description: "Progresión del entrenamiento en casa. Nordic curl asistido: Petersen et al. (2011) 65% reducción de roturas. Wall sit 45s: protocolo validado (Rio et al., 2017). Single leg RDL: propiocepción y fuerza de cadena posterior.", exercises: ["push_up","lunges","nordic_curl","wall_sit","plank","side_plank","dead_bug","glute_bridge","leg_raise","single_leg_rdl"], seriesPerEx: 3, repsPerEx: 10 },
  { id: "home_hiit_explosive", name: "💥 Explosivo HIIT en Casa 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "avanzado", category: "funcional", description: "Alta intensidad con pliometría y calistenia. Lum et al. (2022): 4 semanas de HIIT isométrico-pliométrico mejoran VO2max 6% y CMJ 8%. Descanso corto 45s: maximiza el reclutamiento de unidades motoras de alto umbral.", exercises: ["jump_squat","push_up","lunges","nordic_curl","wall_sit","hip_abduction","side_plank","dead_bug","bird_dog"], seriesPerEx: 4, repsPerEx: 8 },
  { id: "home_posture_mobility", name: "🧘 Postura y Movilidad en Casa 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "corrección", description: "Corrección postural y movilidad sin equipo. McGill (2010): cat-cow + bird dog + dead bug son los 3 ejercicios de mayor relación beneficio/riesgo para la columna lumbar.", exercises: ["cat_cow","bird_dog","dead_bug","glute_bridge","wall_angel","hip_flexor_stretch_iso","thoracic_rotation","side_plank","prone_shoulder_retraction"], seriesPerEx: 2, repsPerEx: 10 },
  { id: "home_glutes_core_female", name: "🍑 Glúteos y Core en Casa 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "principiante", category: "glúteos", description: "Especialización en glúteos y core sin material. Contreras et al. (2011): glute bridge activa 119% MVIC en glúteo mayor. Copenhagen plank: prevención de pubalgia (Harøy et al., 2019). Isométrico 3s en extensión maximiza la contracción glútea.", exercises: ["glute_bridge","hip_abduction","lunges","dead_bug","plank","side_plank","wall_sit","copenhagen_plank","leg_raise"], seriesPerEx: 3, repsPerEx: 15 },

  // BANDAS EXTRA
  { id: "band_beginner_fullbody", name: "🪢 Full Body Principiante — Bandas", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "bandas", description: "Iniciación con bandas tubulares. Resistencia variable genera tensión máxima en extensión completa. Hettinger & Muller (1953): excéntrica 4s + pausa 2s produce adaptaciones neurales desde semana 1. 3×12 con 60s descanso.", exercises: ["tube_band_squat","tube_band_chest_press","tube_band_row_one_arm","tube_band_hip_thrust","tube_band_shoulder_press","dead_bug","plank"], seriesPerEx: 3, repsPerEx: 12 },
  { id: "band_lower_glutes", name: "🪢 Lower Body Glúteos — Bandas", gender: "unisex", daysPerWeek: 5, difficulty: "intermedio", category: "bandas", description: "Tren inferior y glúteos con bandas tubulares. La banda genera resistencia en extensión de cadera completa donde el glúteo produce máxima fuerza. Protocolo Oslo adaptado para isquiotibiales: excéntrica 4s.", exercises: ["tube_band_squat","tube_band_romanian_deadlift","tube_band_hip_thrust","tube_band_lunge","tube_band_good_morning","hip_abduction","dead_bug","side_plank"], seriesPerEx: 4, repsPerEx: 12 },
  { id: "band_core_antirotation", name: "🪢 Core Antirotacional — Bandas", gender: "unisex", daysPerWeek: 3, difficulty: "intermedio", category: "bandas", description: "Core funcional y antirotación con bandas tubulares. McGill (2010): los oblicuos trabajan primariamente como estabilizadores antirotacionales. El Pallof press con banda activa el core en su función real. El leñador diagonal entrena los patrones diagonales funcionales del deporte.", exercises: ["tube_band_pallof_press_band","tube_band_woodchop_high","dead_bug","plank","side_plank","copenhagen_plank","bird_dog","glute_bridge"], seriesPerEx: 3, repsPerEx: 10 },

  // MANCUERNAS
  { id: "dumbbell_upper_lower", name: "🏋️ Upper/Lower Mancuernas 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "intermedio", category: "hipertrofia", description: "División superior/inferior con mancuernas. Schoenfeld (2012): doble frecuencia por grupo muscular produce 33% más hipertrofia que 1×/semana a igual volumen total.", exercises: ["goblet_squat","romanian_deadlift","lunges","single_leg_rdl","hip_abduction","farmer_walk","arnold_press","dumbbell_row","bicep_curl","rear_delt_fly","reverse_fly","side_plank"], seriesPerEx: 4, repsPerEx: 10 },
  { id: "dumbbell_hypertrophy_5days", name: "🔥 Hipertrofia Mancuernas 5 días", gender: "unisex", daysPerWeek: 5, difficulty: "avanzado", category: "hipertrofia", description: "Especialización hipertrófica con mancuernas. Maeo et al. (2021): curl de bíceps en posición de máximo estiramiento produce mayor hipertrofia en cabeza larga. 4×10 con pausa isométrica 1-2s: ~80s TUT/serie, zona óptima de hipertrofia.", exercises: ["goblet_squat","romanian_deadlift","bulgarian_split_squat","lunges","arnold_press","dumbbell_row","bicep_curl","rear_delt_fly","single_leg_rdl","farmer_walk","suitcase_carry","plank"], seriesPerEx: 4, repsPerEx: 10 },
  { id: "dumbbell_glutes_female", name: "🍑 Glúteos Mancuernas 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "intermedio", category: "glúteos", description: "Especialización glútea con mancuernas. Hip thrust con mancuerna activa glúteo mayor 172% MVIC (Contreras et al., 2011). RDL unilateral: isquiotibial + glúteo en máximo rango. Pausa isométrica 2-3s en extensión máxima de cadera.", exercises: ["hip_thrust","goblet_squat","single_leg_rdl","bulgarian_split_squat","glute_bridge","hip_abduction","lunges","dead_bug","side_plank"], seriesPerEx: 4, repsPerEx: 12 },
  { id: "dumbbell_functional", name: "⚙️ Funcional Mancuernas 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "intermedio", category: "funcional", description: "Entrenamiento funcional con mancuernas para rendimiento y vida cotidiana. Farmer walk: ejercicio de transporte más efectivo para core en movimiento. Suitcase carry: activa el cuadrado lumbar en su función más natural.", exercises: ["goblet_squat","lunges","romanian_deadlift","dumbbell_row","arnold_press","farmer_walk","suitcase_carry","plank","dead_bug"], seriesPerEx: 3, repsPerEx: 12 },

  // KETTLEBELL
  { id: "kettlebell_fullbody_intermediate", name: "🫙 Kettlebell Full Body Intermedio 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "intermedio", category: "funcional", description: "Entrenamiento completo con kettlebell. El KB permite movimientos balísticos que entrenan la potencia de la cadena posterior. Bogdanis et al. (2018): la excéntrica cargada seguida de concéntrica explosiva (SSC) aumenta la tasa de desarrollo de fuerza un 43%.", exercises: ["goblet_squat","romanian_deadlift","single_leg_rdl","lunges","dumbbell_row","arnold_press","farmer_walk","suitcase_carry","side_plank","dead_bug"], seriesPerEx: 4, repsPerEx: 10 },
  { id: "kettlebell_strength", name: "💪 Fuerza Kettlebell 5 días", gender: "unisex", daysPerWeek: 5, difficulty: "avanzado", category: "fuerza", description: "Protocolo de fuerza con pesa rusa. Hettinger & Muller (1953): la pausa isométrica de 2-3s en los puntos de carga máxima produce 5% de ganancia semanal. Farmer walk pesado con KB: activación isométrica del core bajo carga compresiva controlada.", exercises: ["goblet_squat","romanian_deadlift","bulgarian_split_squat","single_leg_rdl","dumbbell_row","arnold_press","nordic_curl","farmer_walk","suitcase_carry","plank","copenhagen_plank"], seriesPerEx: 4, repsPerEx: 8 },
  { id: "kettlebell_unilateral", name: "🎯 Unilateral Kettlebell 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "intermedio", category: "funcional", description: "Entrenamiento unilateral con KB para corregir asimetrías y mejorar propiocepción. Youdas et al. (2010): el lado dominante genera 8-12% más fuerza enmascarando déficits. El suitcase carry activa el cuadrado lumbar en su función primaria. RDL unilateral: propiocepción de tobillo.", exercises: ["single_leg_rdl","lunges","bulgarian_split_squat","dumbbell_row","suitcase_carry","hip_abduction","side_plank","dead_bug","bird_dog"], seriesPerEx: 3, repsPerEx: 10 },

  // CALISTENIA ADICIONAL
  { id: "calisthenics_advanced", name: "🤸 Calistenia Avanzado 5 días", gender: "unisex", daysPerWeek: 5, difficulty: "avanzado", category: "calistenia", description: "Calistenia de alto rendimiento. Dominadas con pausa isométrica de 1-2s en la parte alta: activa dorsal y bíceps al máximo. Nordic curl: excéntrica de 5-6s activa unidades motoras de alto umbral. Jump squat 6 reps × 3 series con 120s descanso: protocolo de potencia explosiva (Lum et al., 2021).", exercises: ["pull_up","chin_up","push_up","nordic_curl","jump_squat","single_leg_rdl","plank","side_plank","copenhagen_plank","dead_bug","leg_raise"], seriesPerEx: 4, repsPerEx: 6 },
  { id: "calisthenics_lower_core", name: "🦵 Calistenia Lower + Core 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "intermedio", category: "calistenia", description: "Tren inferior y core con peso corporal. Wall sit 5×45s al 70% MVC: protocolo exacto de Rio et al. (2017). Nordic curl 3×6 con excéntrica de 5s: protocolo Oslo. Bulgarian split squat sin peso: trabajo unilateral. Copenhagen plank 3×20s para aductores.", exercises: ["wall_sit","nordic_curl","bulgarian_split_squat","lunges","jump_squat","glute_bridge","hip_abduction","plank","side_plank","copenhagen_plank"], seriesPerEx: 3, repsPerEx: 10 },

  // ISOMÉTRICO ADICIONAL
  { id: "isometric_multiangle", name: "💪 Isométrico Multiángulo 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "intermedio", category: "fuerza", description: "IST a múltiples ángulos articulares. González & Gorostiaga: cada posición isométrica desarrolla fuerza en ese ángulo ±20°. 3 ángulos × 3 repeticiones × 6s = 54s de tensión total por músculo por sesión.", exercises: ["wall_sit","plank","side_plank","dead_bug","glute_bridge","bird_dog","copenhagen_plank","farmer_walk"], seriesPerEx: 5, repsPerEx: 1 },
  { id: "isometric_tendinopathy", name: "🦴 Isométrico Tendinopatías 4 días", gender: "unisex", daysPerWeek: 4, difficulty: "principiante", category: "funcional", description: "Protocolo específico para tendinopatías. Rio et al. (2017): contracciones isométricas al 70% RM durante 45s producen analgesia inmediata mayor que las isotónicas. Wall sit: tendinopatía rotuliana. Calf raise isométrico: tendinopatía aquílea. 5×45s con 2min descanso.", exercises: ["wall_sit","calf_raise","shoulder_external_rotation","glute_bridge","dead_bug","plank","bird_dog"], seriesPerEx: 5, repsPerEx: 1 },

  // CORRECCIÓN POSTURAL ADICIONAL
  { id: "posture_upper_cross", name: "🧍 Síndrome Cruzado Superior 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "corrección", description: "Síndrome cruzado superior: pectoral y trapecio superior tensos, romboides y flexores cervicales débiles. Activar los inhibidos (band pull apart, face pull, rear delt fly) ANTES de estirar los tensos. Cook (2010): el estiramiento sin activación previa del antagonista es inefectivo a largo plazo.", exercises: ["band_pull_apart","tube_band_face_pull","rear_delt_fly","wall_angel","prone_shoulder_retraction","dead_bug","cat_cow","thoracic_rotation"], seriesPerEx: 3, repsPerEx: 15 },
  { id: "posture_lower_cross", name: "🧍 Síndrome Cruzado Inferior 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "corrección", description: "Síndrome cruzado inferior: psoas e isquiotibiales tensos, glúteo mayor y core débiles. Activar glúteo mayor ANTES de estirar el psoas. Hip flexor stretch isométrico FNP: contracción del glúteo durante el estiramiento activa la inhibición recíproca del psoas (Hindle et al., 2012).", exercises: ["glute_bridge","hip_flexor_stretch_iso","dead_bug","bird_dog","plank","side_plank","cat_cow","hip_abduction"], seriesPerEx: 3, repsPerEx: 10 },
  { id: "posture_shoulder_balance", name: "🤸 Equilibrio Hombro 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "corrección", description: "Equilibrio anterior/posterior del hombro. La ratio empuje:tracción debe ser 1:1.5 para prevenir lesiones del manguito rotador (Cook, 2010). Band pull apart + face pull + rear delt fly activan el trapecio medio, romboides e infraespinoso.", exercises: ["band_pull_apart","face_pull","rear_delt_fly","shoulder_external_rotation","wall_angel","prone_shoulder_retraction","plank","dead_bug"], seriesPerEx: 4, repsPerEx: 15 },

  // FUNCIONAL ADICIONAL
  { id: "functional_senior_50plus", name: "🧓 Funcional 50+ años 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "funcional", description: "Protocolo para mayores de 50 años. Wiles et al. (2017): wall sit 4×2min 3×/semana reduce TAS 9mmHg. Lisón et al.: 1 sesión semanal de isométrico produce mismas ganancias que 2-3 sesiones. Goblet squat con rango parcial preserva movilidad de cadera.", exercises: ["wall_sit","goblet_squat","glute_bridge","dead_bug","bird_dog","plank","hip_flexor_stretch_iso","thoracic_rotation","cat_cow"], seriesPerEx: 2, repsPerEx: 10 },
  { id: "functional_injury_prevention", name: "🛡️ Prevención de Lesiones 3 días", gender: "unisex", daysPerWeek: 3, difficulty: "principiante", category: "funcional", description: "Programa preventivo integral. Nordic curl: -65% roturas isquiotibiales (Petersen et al., 2011). Copenhagen plank: -41% pubalgia (Harøy et al., 2019). Band pull apart: prevención de tendinopatía de manguito rotador. Wall sit: -50% tendinopatía rotuliana (Rio et al., 2017).", exercises: ["nordic_curl","copenhagen_plank","band_pull_apart","single_leg_rdl","wall_sit","shoulder_external_rotation","glute_bridge","side_plank","dead_bug"], seriesPerEx: 3, repsPerEx: 10 },
];
...
window.recoveryRoutines = recoveryRoutines;
window.getFilteredRoutines = getFilteredRoutines;
window.getSuggestedRoutine = getSuggestedRoutine;
window.suggestRecoveryAfterIntenseSessions = suggestRecoveryAfterIntenseSessions;
